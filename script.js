...
function changeProject(number){
    if(number==2){
        // document.getElementById("cb").style.removeProperty("background-color", "blue");
    ...
    //  document.getElementById("cb").style.setProperty("background-color", "blue")
    }
    ...
    if(number==5){
        ...
        let imgArr = ["js.jpeg"];
        let text = ["Assassin", "Tictactoe", "HTML", "Assign 12"];
        let srcarr = ["game.jpg", "tictactoe.png", "Screenshot from 2023-03-21 00-51-29.png", "myProject.webp"];
      for(let i=0; i<aarr.length; i++){
        // document.getElementsByClassName("cl"+i).setAttribute("class",)
         document.getElementById("anchor"+i).setAttribute("href", aarr[i]);
         document.getElementById("proImg"+i).setAttribute("src", imgArr[0]);
        //  document.getElementById("proImg"+i).classList.add(cl[i]);
        // document.getElementById("proImg"+i).setAttribute("className", cl[i]);
         document.getElementById("name"+i).innerText = text[i];
         document.getElementById("hover"+i).setAttribute("src", srcarr[i]);
      }
    //   document.getElementById("cb").style.setProperty("background-color", "blue");
    ...
    //   document.getElementById("cb").style.setProperty("background-color", "blue");
     ...
     if(number==6){
        ...
        let text = ["", "Tictactoe", "HTML", "Assign 12"];
    ...
    //   document.getElementById("cb").style.setProperty("background-color", "blue");
     ...
     if(number==1){
        ...
        let text = ["HI", "Tictactoe", "HTML", "Assign 12"];
    ...
    //   document.getElementById("cb").style.setProperty("background-color", "blue");
     ...
     if(number==3){
        ...
        let imgArr = ["see.png"];
        let text = ["HI", "Tictactoe", "HTML", "Assign 12"];
        let srcarr = ["tictactoe.png", "Swiggy.png", "mmt1.jpg", "tpv.jpeg"];
      for(let i=0; i<aarr.length; i++){
        // document.getElementsByClassName("cl"+i).setAttribute("class",)
         document.getElementById("anchor"+i).setAttribute("href", aarr[i]);
         document.getElementById("proImg"+i).setAttribute("src", imgArr[0]);
